"""Drop-in persistent replacement for module-level dicts in route files.

Wraps an in-memory dict with SQLite persistence so data survives backend
restarts. Designed as a minimal-change migration path: route code replaces
...
_DEFAULT_DB_DIR = os.environ.get("VOICESTUDIO_DATA_DIR", "data")
