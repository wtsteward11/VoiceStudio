...
class PathService:
    ...
    def get_audio_uploads_dir() -> Path:
        return get_path("audio_uploads")

    @staticmethod
    def get_backups_dir() -> Path:
        return get_path("backups")

    @staticmethod
    def get_recordings_dir() -> Path:
        return get_path("recordings")
    ...
    def get_profiles_dir() -> Path:
        return get_path("profiles")

    @staticmethod
    def get_projects_dir() -> Path:
        return get_path("data") / "projects"
