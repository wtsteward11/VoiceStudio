...
namespace VoiceStudio.App.Services
{
  ...
  public static class AppServices
  {
    ...
    // Service-specific accessors are deprecated. Use constructor injection via Generic Host DI.
    // These remain for backward compatibility during migration.
    [Obsolete("Use constructor injection. Register in HostFactory.cs and inject via constructor parameter.")]
