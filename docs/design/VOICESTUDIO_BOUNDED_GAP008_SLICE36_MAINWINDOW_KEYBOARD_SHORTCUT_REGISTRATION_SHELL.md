...
**Panel quick-switch Ctrl+1–9** moved to **`MainWindowPanelQuickSwitchShortcutRegistrationShellBridge`** (**[Slice 37](VOICESTUDIO_BOUNDED_GAP008_SLICE37_MAINWINDOW_PANEL_QUICK_SWITCH_SHORTCUT_REGISTRATION_SHELL.md)**); **Slice 36** no longer takes **`registerPanelQuickSwitchGroup`** on **`MainWindowKeyboardShortcutRegistrationDependencies`**.
...
| **(historical)** **`registerPanelQuickSwitchGroup`** — superseded by **Slice 37** **`MainWindowPanelQuickSwitchShortcutRegistrationShellBridge`** | **Task 103** / **113** / **123** / **134** / **148** / **158** / **168** / **178** — not spine gates (optional runtime / appendix) |
...
| **Explicitly OUT** Moving **`RegisterPanelQuickSwitchShortcut`** into **this** bridge (**Slice 37** owns that extraction). Moving **`IsGateCSmokeMode` / `IsSafeStartupMode`** (used elsewhere). **Transport** recording shortcuts in **Loaded** — not here. |
...
- **`MainWindow`**: no **`private void RegisterKeyboardShortcuts`**. **`_keyboardShortcutRegistrationShellBridge`** field; ctor calls **`Register`**. **Ctrl+1–9** panel quick-switch registrations → **Slice 37** **`MainWindowPanelQuickSwitchShortcutRegistrationShellBridge`** (post–Slice 37 land).  
...
- 2026-04-26: **Slice 37** — **`registerPanelQuickSwitchGroup`** removed from **`MainWindowKeyboardShortcutRegistrationDependencies`**; **Ctrl+1–9** registrations moved to **`MainWindowPanelQuickSwitchShortcutRegistrationShellBridge`** ([Slice 37 brief](VOICESTUDIO_BOUNDED_GAP008_SLICE37_MAINWINDOW_PANEL_QUICK_SWITCH_SHORTCUT_REGISTRATION_SHELL.md)).
