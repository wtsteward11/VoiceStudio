...
| Session State | `.cursor/STATE.md` | 2026-03-28 | **Global Quick** **`20260327_175838`** / **`ab52c3de`** (**C3A**); **`run_verification`** **`20260327-180547`**; **Active** **`GOV-STASH0-T1-C3B-EXEC-01`** **open** — **§1** implementation **Pending**; **C3c** **`stash@{0}`** **parked**; **W7** / Product trust / **W8** paused unless signed reopen. |
...
| **Stash T1-C3b auth middleware execution row** | `docs/design/STASH0_T1_C3B_EXECUTION_ROW.md` | 2026-03-28 | **`GOV-STASH0-T1-C3B-EXEC-01`** — **open**; **§4** **`auth_middleware.py`** + **`test_auth_middleware.py`**; **§1** implementation **Pending**; **§5** frozen pytest + **Quick** for closure; **`stash@{0}`** selective checkout per **§7**. |
