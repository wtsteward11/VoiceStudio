...
| Session State | `.cursor/STATE.md` | 2026-03-27 | **Global Quick** **`20260326_230934`** / **`f6047797`** (**T1-S1** §8); **`run_verification`** **`20260327-145802`**; **`main`** may lag branch **`stash0-t1-s1-01`** until merge; **T2** historical; **`stash@{0}`** **parked**; **W7** / Product trust / **W8** paused unless signed reopen. |
...
| **Stash T1-S1 synthesis vertical execution row** | `docs/design/STASH0_T1_S1_EXECUTION_ROW.md` | 2026-03-27 | **`GOV-STASH0-T1-S1-01`** — **closed**; eight-path **§4** selective checkout; branch **`stash0-t1-s1-01`** (tip may be **`3127094d`** closure doc commit; pointer **`f6047797`**); Quick **`20260326_230934`**; **`run_verification`** **`20260327-145802`** (ledger sync **2026-03-27**); §8 filled; **`stash@{0}`** **parked**. |
