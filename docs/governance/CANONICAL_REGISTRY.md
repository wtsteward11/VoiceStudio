...
| Session State | `.cursor/STATE.md` | 2026-03-27 | **Global Quick** **`20260327_165459`** / **`0e0d0a91`** (**R1A** §8); **`run_verification`** **`20260327-170011`**; **`GOV-STASH0-T1-R1A-EXEC-01`** **closed**; **T1-S1** Quick **`20260326_230934`** historical; **`stash@{0}`** **parked** (T1-C3/T3/T4); **W7** / Product trust / **W8** paused unless signed reopen. |
