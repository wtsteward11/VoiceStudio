...
| Session State | `.cursor/STATE.md` | 2026-03-27 | **Global Quick** **`20260326_230934`** / **`f6047797`** (**T1-S1** §8); **`run_verification`** **`20260327-151108`**; **`main`** carries **T1-S1**; **Active:** planning-only **`GOV-STASH0-T1-R1-PREFLIGHT-01`** (T1 remainder re-baseline); **T2** historical; **`stash@{0}`** **parked**; **W7** / Product trust / **W8** paused unless signed reopen. |
...
| **Stash T1-S1 synthesis vertical execution row** | `docs/design/STASH0_T1_S1_EXECUTION_ROW.md` | 2026-03-27 | **`GOV-STASH0-T1-S1-01`** — **closed** on **`main`** (**`13486a4d`**); eight-path **§4**; Quick **`20260326_230934`** / pointer **`f6047797`**; **`run_verification`** **`20260327-151108`** (post-merge ledger); §8; **`stash@{0}`** **parked**. |
...
| **Stash T1 remainder preflight (post–T1-S1)** | `docs/design/STASH0_T1_R1_PREFLIGHT_EXECUTION_ROW.md` | 2026-03-27 | **`GOV-STASH0-T1-R1-PREFLIGHT-01`** — **`stash@{0}`** vs **`main`** re-baseline; **§5** slice choice; **§1** **Pending**; **planning-only** (no **§4** lock here). |
