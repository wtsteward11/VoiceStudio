...
| Session State | `.cursor/STATE.md` | 2026-03-26 | **Global Quick** **`20260326_211554`** / **`dc07e515`** (**T2** closure); **P05-Persist-A4** **`20260326_163358`** historical; **`stash@{0}`** **parked**; **T2** = [STASH0_T2_VERIFY_CI_EXECUTION_ROW.md](../design/STASH0_T2_VERIFY_CI_EXECUTION_ROW.md) (**closed**); **W7** / Product trust / **W8** paused unless signed reopen. |
