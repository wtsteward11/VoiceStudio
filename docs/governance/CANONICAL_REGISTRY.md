...
| Session State | `.cursor/STATE.md` | 2026-03-26 | **Global Quick** **`20260326_230934`** / **`f6047797`** (**GOV-STASH0-T1-S1-01** §8); **`run_verification`** **`20260326-232319`**; **T2** Quick **`20260326_211554`** historical tip until merge; **`stash@{0}`** **parked**; **W7** / Product trust / **W8** paused unless signed reopen. |
...
| **Stash T1-S1 synthesis vertical execution row** | `docs/design/STASH0_T1_S1_EXECUTION_ROW.md` | 2026-03-26 | **`GOV-STASH0-T1-S1-01`** — **closed**; eight-path **§4** selective checkout; branch **`stash0-t1-s1-01`** **`f6047797`**; Quick **`20260326_230934`**; **`run_verification`** **`20260326-232319`**; §8 filled; **`stash@{0}`** **parked**. |
