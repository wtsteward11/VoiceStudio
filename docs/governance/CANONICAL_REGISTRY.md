...
| Session State | `.cursor/STATE.md` | 2026-03-28 | **Global Quick** **`20260327_165459`** / **`0e0d0a91`** (**R1A** §8); **`run_verification`** **`20260327-170011`**; **Active planning** **`GOV-STASH0-T1-C3-PREFLIGHT-01`** ([`STASH0_T1_C3_PREFLIGHT_EXECUTION_ROW.md`](../design/STASH0_T1_C3_PREFLIGHT_EXECUTION_ROW.md)); **`GOV-STASH0-T1-R1A-EXEC-01`** **closed**; **`stash@{0}`** **parked**; **W7** / Product trust / **W8** paused unless signed reopen. |
...
| **Stash T1-C3 cross-cutting preflight (post–R1A)** | `docs/design/STASH0_T1_C3_PREFLIGHT_EXECUTION_ROW.md` | 2026-03-28 | **`GOV-STASH0-T1-C3-PREFLIGHT-01`** — **planning-only**; **§3/§4** re-baseline on **`main`** **`37fb89e6`**; **§1** product slice choice **Pending**; **§5** default **Option A** (**C3a** rate limits first); **no** code / stash extract under this row; child execution row **after** sign-off. |
