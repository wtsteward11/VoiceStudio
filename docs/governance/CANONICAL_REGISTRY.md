...
| Session State | `.cursor/STATE.md` | 2026-03-28 | **Global Quick** **`20260327_175838`** / **`ab52c3de`** (**C3A** §8); **`run_verification`** **`20260327-180444`**; **`GOV-STASH0-T1-C3A-EXEC-01`** **closed**; **T1-C3** **C3b/C3c** **`stash@{0}`** **parked**; **W7** / Product trust / **W8** paused unless signed reopen. |
...
| **Stash T1-C3a rate limiting execution row** | `docs/design/STASH0_T1_C3A_EXECUTION_ROW.md` | 2026-03-28 | **`GOV-STASH0-T1-C3A-EXEC-01`** — **closed**; **§8** Quick **`20260327_175838`** / **`ab52c3de`**; **`run_verification`** **`20260327-180444`**; **§4** two-path selective **`stash@{0}`** checkout; **`stash@{0}`** retained; **C3b/C3c** next. |
