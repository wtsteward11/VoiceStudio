...
> **Last Updated**: 2026-03-28 — **`GOV-STASH0-T1-C3B-EXEC-01`** **closed**; **Active (T1):** **`GOV-STASH0-T1-C3C-EXEC-01`** **open** ([`STASH0_T1_C3C_EXECUTION_ROW.md`](../design/STASH0_T1_C3C_EXECUTION_ROW.md)) — **§1** **implementation** **Pending**; **no** **`stash@{0}`** extract until **Go**; **T3** firewall in **§6**. **Repo-global Quick** ([`latest_pointer.json`](../../artifacts/verify/latest_pointer.json)): **`artifacts/verify/20260327_182409`** (PASS) — **`GOV-STASH0-T1-C3B-EXEC-01`**; **`commit_hash`** **`9f550a0f32a9039064677abcfe1c8d18b2ba735c`**. **Prior** (**C3A**): **`20260327_175838`** / **`ab52c3de`**. **Prior** (**R1A**): **`20260327_165459`** / **`0e0d0a91`**. **Prior** (**T1-S1**): **`20260326_230934`** / **`f6047797`**. **`run_verification`** **`timestamp_short`** must match **`.buildlogs/verification/last_run.json`** **verbatim** when cited (**`20260327-182920`** at row authorship — **re-read file** after any local **`run_verification.py`**). **`git rev-parse HEAD` / `main`** — **may** differ from **pointer** after docs-only commits; **Quick** tip remains **`9f550a0f`** until new **Quick** passes. **T2** / **P05-A4** / **W8** / **W7** / Product trust / **Pass 06** — **historical** or **paused** per linked docs.
...
| Session State | `.cursor/STATE.md` | 2026-03-28 | **Global Quick** **`20260327_182409`** / **`9f550a0f`** (**C3B**); **`run_verification`** per **`.buildlogs/verification/last_run.json`** (**verbatim**); **`GOV-STASH0-T1-C3C-EXEC-01`** **open** — **§1** **Pending**; **`GOV-STASH0-T1-C3B-EXEC-01`** **closed**; **W7** / Product trust / **W8** paused unless signed reopen. |
...
| **Stash T1-C3a rate limiting execution row** | `docs/design/STASH0_T1_C3A_EXECUTION_ROW.md` | 2026-03-28 | **`GOV-STASH0-T1-C3A-EXEC-01`** — **closed**; **§8** Quick **`20260327_175838`** / **`ab52c3de`**; **`run_verification`** **`20260327-180547`** (**C3A** closure-era ledger); **§4** two-path selective **`stash@{0}`** checkout; children **C3B** **closed**; **C3C** row **open**. |
| **Stash T1-C3b auth middleware execution row** | `docs/design/STASH0_T1_C3B_EXECUTION_ROW.md` | 2026-03-28 | **`GOV-STASH0-T1-C3B-EXEC-01`** — **closed**; **§8** Quick **`20260327_182409`** / **`9f550a0f`**; **`run_verification`** **`20260327-182920`** (closure-era **`.buildlogs`**); **§4** two-path selective **`stash@{0}`** checkout + **`fix(test)`** **`project_root`**; **`stash@{0}`** retained; child **C3C** row **open**. |
| **Stash T1-C3c models_additional execution row** | `docs/design/STASH0_T1_C3C_EXECUTION_ROW.md` | 2026-03-28 | **`GOV-STASH0-T1-C3C-EXEC-01`** — **open**; **T3-adjacent** **§4** (**`models_additional.py`** + **`test_models_additional.py`**); **§1** **implementation** **Pending**; **§6** **T3** firewall; **`stash@{0}`** selective checkout per **§7** after **Go**. |
