...
MIGRATED_NO_IBACKENDCLIENT = [
    ...
    "TrainingQualityVisualizationViewModel",
    "VideoEditViewModel",
    "VideoGenViewModel",
    "AdvancedRealTimeVisualizationViewModel",
    "AudioMonitoringDashboardViewModel",
    "ImageVideoEnhancementPipelineViewModel",
    "SLODashboardViewModel",
    "TagOrganizationViewModel",
    ...
    "EnsembleSynthesisViewModel",
    "MiniTimelineViewModel",
    "AIMixingMasteringViewModel",
    "AIProductionAssistantViewModel",
    "AdvancedSpectrogramVisualizationViewModel",
    ...
    "VoiceBrowserViewModel",
    "VoiceMorphViewModel",
    "VoiceMorphingBlendingViewModel",
    "VoiceQuickCloneViewModel",
    "VoiceStyleTransferViewModel",
    "WorkflowAutomationViewModel",
    "StyleTransferViewModel",
    "TagManagerViewModel",
    "UpscalingViewModel",
    "EngineParameterTuningViewModel",
    "ImageGenViewModel",
    "SpectrogramViewModel",
    "SpatialAudioViewModel",
    "PluginHealthDashboardViewModel",
    "ProfileHealthDashboardViewModel",
    ...
    "TodoPanelViewModel",
    "HelpViewModel",
    "EmotionStylePresetEditorViewModel",
