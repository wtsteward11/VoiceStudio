...
VALID_GATEC_PROOF = {
    ...
    "ui_smoke": {
        ...
        "synthesis_step_ran": True,
        "audio_id": "smoke-audio-id",
        "stream_check_passed": True,
        "temp_file_created": True,
        "playback_started": True,
        "playback_position_advanced_ms": 500,
        "library_temp_file_created": True,
        "library_playback_started": True,
        "library_playback_position_advanced_ms": 400,
